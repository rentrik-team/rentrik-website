...
export default function NotFound() {
  return (
    <section className="relative flex min-h-[calc(100vh-180px)] flex-col items-center justify-center px-6 py-24">
      ...
      >
        ...
        <p className="text-muted mb-2 text-6xl font-black tracking-tighter md:text-8xl">
          404
        </p>
        <h1 className="mb-4 text-2xl font-black tracking-tighter text-white uppercase md:text-3xl">
          Page not found
        </h1>
        <p className="text-muted mx-auto mb-10 max-w-md text-sm leading-relaxed">
